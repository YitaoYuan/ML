...
def get_training_dataloader(mean, std, batch_size=16, num_workers=2):
    ...
    sampler = torch.utils.data.distributed.DistributedSampler(cifar100_training, shuffle=True)
    cifar100_training_loader = DataLoader(
        cifar100_training, shuffle=False, num_workers=num_workers, batch_size=batch_size, sampler=sampler)

    return cifar100_training_loader, sampler

def get_test_dataloader(mean, std, batch_size=16, num_workers=2):
    """ return training dataloader
    Args:
